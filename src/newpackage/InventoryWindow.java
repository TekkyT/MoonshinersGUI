...
public class InventoryWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select to Use:", "Placeholder1", "Placeholder2" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO 
        // Still need to add black market items to the use category.
        switch(s1) {
            case "" -> {
